...
{
    public partial class Dos2GrayScaleUserControl : UserControl
    {
        ...
        private void GrayGenerate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Dos2GrayScaleImporter importer = new Dos2GrayScaleImporter(dosFileName, grayScaleFileName, minHeight, maxHeight);
